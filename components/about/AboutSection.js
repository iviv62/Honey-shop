...
const AboutSection = () => {
    return (
        <section className="font-sans bg-white container mx-auto px-5 flex flex-grow">
  <div className="flex flex-col items-center py-8">
    <div className="flex flex-col w-full mb-12 text-left">
      <div className="w-full mx-auto lg:w-1/2">
        <h1 className="mx-auto mb-6 text-2xl font-semibold text-black lg:text-3xl">A few words about us</h1>
        <Image
        ...
        <h3 className="mx-auto mt-4 mb-4 text-xl font-semibold text-black">Make challenges</h3>
